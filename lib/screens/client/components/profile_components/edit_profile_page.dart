...
import 'package:rider/logic/apis/update_profile.dart';
import 'package:rider/screens/client/components/profile_components/partial_profile_card.dart';
          ...
          child: Column(
            children: [
              ...
              PartialEditCard(
                ...
                chgFirstName: (value) => firstName = value,
                chgGender: (value) => gender = value,
                chgLastName: (value) => lastName = value,
                chgMaritalStatus: (value) => maritalStatus = value,
              ...
              RoundedButton(
                color: kPrimaryColor,
                press: () async {
                  final Future<UpdateProfile> successfulMessage = updateProfile(
                    address: address,
                    firstName: firstName,
                    gender: gender,
                    lastName: lastName,
